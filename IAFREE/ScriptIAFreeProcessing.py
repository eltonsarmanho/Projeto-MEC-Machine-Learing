...
def processing(df,fatores_Est,fatores,dimensoes_Est,dimensoes):
    ...
    for index, row in df.iterrows():
        fator_est, created = FatorEST.objects.using('prediction').update_or_create(
            ...
            defaults={
                'E_ESC1V': float(fatores_Est.loc[index, 'E-ESC1V']),
                'E_ESC2V': float(fatores_Est.loc[index, 'E-ESC2V']),
                'E_PROF1V': float(fatores_Est.loc[index, 'E-PROF1V']),
                'E_PROF2V': float(fatores_Est.loc[index, 'E-PROF2V']),
                'E_FAM1V': float(fatores_Est.loc[index, 'E-FAM1V']),
                'E_FAM2V': float(fatores_Est.loc[index, 'E-FAM2V']),
                'E_COM1V': float(fatores_Est.loc[index, 'E-COM1V']),
                'E_COM2V': float(fatores_Est.loc[index, 'E-COM2V']),
                'E_COM3V': float(fatores_Est.loc[index, 'E-COM3V']),
                'E_EST1V': float(fatores_Est.loc[index, 'E-EST1V']),
                'E_EST2V': float(fatores_Est.loc[index, 'E-EST2V']),
                'E_EST3V': float(fatores_Est.loc[index, 'E-EST3V']),
    ...
    for index, row in dimensoes_Est.iterrows():
        dimensoes_est, created = DimensaoEST.objects.using('prediction').update_or_create(
            ...
            defaults={
                'E_ESCV': float(dimensoes_Est.loc[index, 'E-ESCV']),
                'E_PROFV': float(dimensoes_Est.loc[index, 'E-PROFV']),
                'E_FAMV': float(dimensoes_Est.loc[index, 'E-FAMV']),
                'E_COMV': float(dimensoes_Est.loc[index, 'E-COMV']),
                'E_ESTV': float(dimensoes_Est.loc[index, 'E-ESTV']),
